...
<div role="tabpanel">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation">
                <a class="navbar-brand" href="index.php">Rental Mobil <b>KALIPURO</b></a>
            </li>
            <li role="presentation">
    ...
    <?php
        ...
        $thn = date("Y");
    ?>
    <h1 align="center">RENTAL MOBIL KALIPURO</h1>
    <h5 align="center">Alamat : Jl. Argopuro no 07 kalipuro</h5>
    <hr/>
